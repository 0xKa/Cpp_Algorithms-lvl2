...
float AverageOfNumbersInArray(int ArrayLength, int arr[100])
{
	return (float)SumOfNumbersInArray(ArrayLength, arr) / ArrayLength;
...
int main()
{
	...
	cout << "\n\nThe Sum of Numbers in Array = " << AverageOfNumbersInArray(ArrayLength, arr);
